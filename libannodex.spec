...
Summary(pl):	Biblioteka do odczytu i zapisu mediów w formacie Annodex
Name:		libannodex
Version:	0.7.3
Release:	1
License:	BSD
...
%description -l pl
libannodex to biblioteka pozwalaj±ca na odczyt i zapis plików i
strumieni w formacie Annodex.

%package devel
Summary:	Header files for libannodex library
Summary(pl):	Pliki nag³ówkowe biblioteki libannodex
...
Pliki nag³ówkowe biblioteki libannodex.
